...
export default function CheckboxSingle({id, label, checked, disabled, onChange}) {
    ...
    return (
        <div className="relative flex gap-2 items-center">
            ...
            <label
                htmlFor={`checkbox-${id}`}
                className="textMuted peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
            >
                {label}
            </label>
